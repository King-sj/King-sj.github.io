...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="配置nginx反向代理-使flask支持-https" tabindex="-1"><a class="header-anchor" href="#配置nginx反向代理-使flask支持-https"><span>配置nginx反向代理，使flask支持 https</span></a></h2><p>#TODO - 添加flask+nginx配置</p><h1 id="改进方向" tabindex="-1"><a class="header-anchor" href="#改进方向"><span>改进方向</span></a></h1><p>[ ] 将卷的挂载目录改为由命令输入，而不是硬编码</p><h2 id="参考资料" tabindex="-1"><a class="header-anchor" href="#参考资料"><span>参考资料</span></a></h2>`,41),h={href:"https://nginx.org/en/docs/",target:"_blank",rel:"noopener noreferrer"},k={href:"https://flask.palletsprojects.com/en/2.0.x/",target:"_blank",rel:"noopener noreferrer"},_={href:"https://www.digitalocean.com/community/tutorials/understanding-nginx-http-proxying-load-balancing-buffering-and-caching",target:"_blank",rel:"noopener noreferrer"},x={href:"https://letsencrypt.org/getting-started/",target:"_blank",rel:"noopener noreferrer"},f={href:"https://zhuanlan.zhihu.com/p/347064501",target:"_blank",rel:"noopener noreferrer"},y={href:"https://www.cnblogs.com/vishun/p/15746849.html",target:"_blank",rel:"noopener noreferrer"},w={href:"https://sleele.com/2021/04/15/docker-acme-with-docker-nginx/",target:"_blank",rel:"noopener noreferrer"},A={href:"https://geek-docs.com/flask/flask-questions/4_flask_can_you_add_https_functionality_to_a_python_flask_web_server.html#google_vignette",target:"_blank",rel:"noopener noreferrer"};function $(T,D){const a=t("router-link"),l=t("ExternalLinkIcon");return o(),c("div",null,[n("nav",v,[n("ul",null,[n("li",null,[e(a,{to:"#环境"},{default:i(()=>[s("环境")]),_:1})]),n("li",null,[e(a,{to:"#项目结构"},{default:i(()=>[s("项目结构")]),_:1})]),n("li",null,[e(a,{to:"#配置http服务"},{default:i(()=>[s("配置http服务")]),_:1}),n("ul",null,[n("li",null,[e(a,{to:"#配置nginx"},{default:i(()=>[s("配置nginx")]),_:1})]),n("li",null,[e(a,{to:"#配置docker"},{default:i(()=>[s("配置docker")]),_:1})]),n("li",null,[e(a,{to:"#启动项目"},{default:i(()=>[s("启动项目")]),_:1})])])]),n("li",null,[e(a,{to:"#升级为https"},{default:i(()=>[s("升级为https")]),_:1}),n("ul",null,[n("li",null,[e(a,{to:"#申请证书"},{default:i(()=>[s("申请证书")]),_:1})]),n("li",null,[e(a,{to:"#修改配置"},{default:i(()=>[s("修改配置")]),_:1})]),n("li",null,[e(a,{to:"#重启container"},{default:i(()=>[s("重启container")]),_:1})])])]),n("li",null,[e(a,{to:"#配置nginx反向代理-使flask支持-https"},{default:i(()=>[s("配置nginx反向代理，使flask支持 https")]),_:1})]),n("li",null,[e(a,{to:"#参考资料"},{default:i(()=>[s("参考资料")]),_:1})])])]),m,b,d(" more "),g,n("ol",null,[n("li",null,[n("a",h,[s("Nginx Documentation"),e(l)])]),n("li",null,[n("a",k,[s("Flask Documentation"),e(l)])]),n("li",null,[n("a",_,[s("Reverse Proxy Guide"),e(l)])]),n("li",null,[n("a",x,[s("SSL Certificates"),e(l)])]),n("li",null,[n("a",f,[s("用acme.sh帮你免费且自动更新的HTTPS证书，省时又省力"),e(l)])]),n("li",null,[n("a",y,[s("docker部署certbot与nginx来获取ssl证书添加https及自动更新"),e(l)])]),n("li",null,[n("a",w,[s("使用docker acme申请、续订泛域名证书，并自动重载docker nginx"),e(l)])]),n("li",null,[n("a",A,[s("Flask: 如何给Python Flask Web服务器添加HTTPS功能"),e(l)])])])])}const N=r(p,[["render",$],["__file","docker_nginx部署web项目.html.vue"]]),S=JSON.parse('{"path":"/tech/docker_nginx%E9%83%A8%E7%BD%B2web%E9%A1%B9%E7%9B%AE.html","title":"docker + nginx + acme.sh 部署 vue/flask 项目","lang":"zh-CN","frontmatter":{"author":"King-sj","date":"2024-09-16T00:00:00.000Z","category":["nginx"],"tag":["部署"],"star":true,"description":"docker + nginx + acme.sh 部署 vue/flask 项目 本文将介绍如何使用 Docker、Nginx 和 acme.sh 部署一个 Vue 和 Flask 项目。我们将详细讲解环境配置、项目结构、Nginx 配置、Docker 配置以及如何升级到 HTTPS。","head":[["meta",{"property":"og:url","content":"https://github.com/King-sj/tech/docker_nginx%E9%83%A8%E7%BD%B2web%E9%A1%B9%E7%9B%AE.html"}],["meta",{"property":"og:site_name","content":"blog"}],["meta",{"property":"og:title","content":"docker + nginx + acme.sh 部署 vue/flask 项目"}],["meta",{"property":"og:description","content":"docker + nginx + acme.sh 部署 vue/flask 项目 本文将介绍如何使用 Docker、Nginx 和 acme.sh 部署一个 Vue 和 Flask 项目。我们将详细讲解环境配置、项目结构、Nginx 配置、Docker 配置以及如何升级到 HTTPS。"}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"og:updated_time","content":"2024-10-18T04:29:13.000Z"}],["meta",{"property":"article:author","content":"King-sj"}],["meta",{"property":"article:tag","content":"部署"}],["meta",{"property":"article:published_time","content":"2024-09-16T00:00:00.000Z"}],["meta",{"property":"article:modified_time","content":"2024-10-18T04:29:13.000Z"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"docker + nginx + acme.sh 部署 vue/flask 项目\\",\\"image\\":[\\"\\"],\\"datePublished\\":\\"2024-09-16T00:00:00.000Z\\",\\"dateModified\\":\\"2024-10-18T04:29:13.000Z\\",\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"King-sj\\"}]}"]]},"headers":[{"level":2,"title":"环境","slug":"环境","link":"#环境","children":[]},{"level":2,"title":"项目结构","slug":"项目结构","link":"#项目结构","children":[]},{"level":2,"title":"配置http服务","slug":"配置http服务","link":"#配置http服务","children":[{"level":3,"title":"配置nginx","slug":"配置nginx","link":"#配置nginx","children":[]},{"level":3,"title":"配置docker","slug":"配置docker","link":"#配置docker","children":[]},{"level":3,"title":"启动项目","slug":"启动项目","link":"#启动项目","children":[]}]},{"level":2,"title":"升级为https","slug":"升级为https","link":"#升级为https","children":[{"level":3,"title":"申请证书","slug":"申请证书","link":"#申请证书","children":[]},{"level":3,"title":"修改配置","slug":"修改配置","link":"#修改配置","children":[]},{"level":3,"title":"重启container","slug":"重启container","link":"#重启container","children":[]}]},{"level":2,"title":"配置nginx反向代理，使flask支持 https","slug":"配置nginx反向代理-使flask支持-https","link":"#配置nginx反向代理-使flask支持-https","children":[]},{"level":2,"title":"参考资料","slug":"参考资料","link":"#参考资料","children":[]}],"git":{"createdTime":1729225753000,"updatedTime":1729225753000,"contributors":[{"name":"King","email":"2175616761@qq.com","commits":1}]},"readingTime":{"minutes":2.69,"words":808},"filePathRelative":"tech/docker+nginx部署web项目.md","localizedDate":"2024年9月16日","excerpt":"\\n<h1>docker + nginx + acme.sh 部署 vue/flask 项目</h1>\\n<p>本文将介绍如何使用 Docker、Nginx 和 acme.sh 部署一个 Vue 和 Flask 项目。我们将详细讲解环境配置、项目结构、Nginx 配置、Docker 配置以及如何升级到 HTTPS。</p>\\n","autoDesc":true}');export{N as comp,S as data};
