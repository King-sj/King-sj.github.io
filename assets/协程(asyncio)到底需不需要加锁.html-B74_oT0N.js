...
0
0
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>是的，无论是结果，还是过程中，都保持了其一致性，但是我们也付出了相应的代价，那就是任务又回到了线性同步执行，再也没有异步的加持了。话说回来，世界上的事情本来就是这样，本来就没有两全其美的解决方案，又要共享状态，又想多协程，还想变量安全，这可能吗？</p><h2 id="协程是否需要加锁" tabindex="-1"><a class="header-anchor" href="#协程是否需要加锁"><span>协程是否需要加锁</span></a></h2><p>结论当然就是看使用场景，如果协程在操作共享变量的过程中，没有主动放弃执行权(await)，也就是没有切换挂起状态，那就不需要加锁，执行过程本身就是安全的；可是如果在执行事务逻辑块中主动放弃执行权了，会分两种情况，如果在逻辑执行过程中我们需要判断变量状态，或者执行过程中要根据变量状态进行一些下游操作，则必须加锁，如果我们不关注执行过程中的状态，只关注最终结果一致性，则不需要加锁。是的，抛开剂量谈毒性，是不客观的，给一个健康的人注射吗啡是犯罪，但是给一个垂死的人注射吗啡，那就是最大的道德，所以说，道德不是空泛的，脱离对象孤立存在的，同理，抛开场景谈逻辑，也是不客观的，协程也不是虚空的，脱离具体场景孤立存在的，我们应该养成具体问题具体分析的辩证唯物思想，只有掌握了辩证的矛盾思维才能更全面更灵活的看待问题，才能透过现象，把握本质。</p>`,44),k={href:"https://link.segmentfault.com/?enc=aOuNWC7a1JCzFai3ycjkKg%3D%3D.l5t0sKltIhLGYnZPLxsFYIiEbKuxzYikfYFHmurPNGM%3D",target:"_blank",rel:"noopener noreferrer"};function h(g,_){const s=t("ExternalLinkIcon");return l(),c("div",null,[n("h1",r,[n("a",u,[n("span",null,[n("a",v,[a("并发异步编程之争：协程(asyncio)到底需不需要加锁？(线程/协程安全/挂起/主动切换)Python3"),e(s)])])])]),n("p",null,[a("原文转载自「刘悦的技术博客」"),n("a",m,[a("https://v3u.cn/a_id_208"),e(s)])]),o(" more "),b,n("p",null,[a("原文转载自「刘悦的技术博客」 "),n("a",k,[a("https://v3u.cn/a_id_208"),e(s)])])])}const f=i(d,[["render",h],["__file","协程(asyncio)到底需不需要加锁.html.vue"]]),w=JSON.parse('{"path":"/tech/%E5%8D%8F%E7%A8%8B(asyncio)%E5%88%B0%E5%BA%95%E9%9C%80%E4%B8%8D%E9%9C%80%E8%A6%81%E5%8A%A0%E9%94%81.html","title":"并发异步编程之争：协程(asyncio)到底需不需要加锁？(线程/协程安全/挂起/主动切换)Python3","lang":"zh-CN","frontmatter":{"description":"原文转载自「刘悦的技术博客」https://v3u.cn/a_id_208","head":[["meta",{"property":"og:url","content":"https://github.com/King-sj/tech/%E5%8D%8F%E7%A8%8B(asyncio)%E5%88%B0%E5%BA%95%E9%9C%80%E4%B8%8D%E9%9C%80%E8%A6%81%E5%8A%A0%E9%94%81.html"}],["meta",{"property":"og:site_name","content":"blog"}],["meta",{"property":"og:title","content":"并发异步编程之争：协程(asyncio)到底需不需要加锁？(线程/协程安全/挂起/主动切换)Python3"}],["meta",{"property":"og:description","content":"原文转载自「刘悦的技术博客」https://v3u.cn/a_id_208"}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:image","content":"https://segmentfault.com/img/remote/1460000041568841"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"og:updated_time","content":"2024-10-21T02:58:43.000Z"}],["meta",{"property":"article:author","content":"KSJ"}],["meta",{"property":"article:modified_time","content":"2024-10-21T02:58:43.000Z"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"并发异步编程之争：协程(asyncio)到底需不需要加锁？(线程/协程安全/挂起/主动切换)Python3\\",\\"image\\":[\\"https://segmentfault.com/img/remote/1460000041568841\\"],\\"dateModified\\":\\"2024-10-21T02:58:43.000Z\\",\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"KSJ\\",\\"url\\":\\"https://github.com/King-sj\\"}]}"]]},"headers":[{"level":2,"title":"线程安全","slug":"线程安全","link":"#线程安全","children":[]},{"level":2,"title":"协程","slug":"协程","link":"#协程","children":[]},{"level":2,"title":"协程安全","slug":"协程安全","link":"#协程安全","children":[]},{"level":2,"title":"协程是否需要加锁","slug":"协程是否需要加锁","link":"#协程是否需要加锁","children":[]}],"git":{"createdTime":1729479523000,"updatedTime":1729479523000,"contributors":[{"name":"King","email":"2175616761@qq.com","commits":1}]},"readingTime":{"minutes":10.04,"words":3013},"filePathRelative":"tech/协程(asyncio)到底需不需要加锁.md","localizedDate":"2024年10月21日","excerpt":"\\n<p>原文转载自「刘悦的技术博客」<a href=\\"https://link.segmentfault.com/?enc=8btt3pfGP%2FRxuxLguNqhrg%3D%3D.f%2BWWJlm9AsMAbAJjJZT%2BOQBqYNXwZgTYGW7Jx9l%2BpxQ%3D\\" target=\\"_blank\\" rel=\\"noopener noreferrer\\">https://v3u.cn/a_id_208</a></p>\\n","autoDesc":true}');export{f as comp,w as data};
