import{_ as i,r as t,o as l,c,b as n,f as a,d as e,e as o}from"./app-DlGMjcXX.js";const p={},d={id:"并发异步编程之争-协程-asyncio-到底需不需要加锁-线程-协程安全-挂起-主动切换-python3",tabindex:"-1"},r={class:"header-anchor",href:"#并发异步编程之争-协程-asyncio-到底需不需要加锁-线程-协程安全-挂起-主动切换-python3"},u={href:"https://segmentfault.com/a/1190000041568839",target:"_blank",rel:"noopener noreferrer"},v=n("figure",null,[n("img",{src:"https://avatar-static.segmentfault.com/272/694/2726948578-60fd1deec0c0b_huge128",alt:"头像",tabindex:"0",loading:"lazy"}),n("figcaption",null,"头像")],-1),m=n("p",null,[n("strong",null,"刘悦的技术博客")],-1),b={href:"https://segmentfault.com/a/1190000041568839/revision",target:"_blank",rel:"noopener noreferrer"},k=n("p",null,"阅读 6 分钟",-1),h=n("figure",null,[n("img",{src:"https://segmentfault.com/img/bVcYz7i?spec=cover",alt:"头图",tabindex:"0",loading:"lazy"}),n("figcaption",null,"头图")],-1),g={href:"https://link.segmentfault.com/?enc=8btt3pfGP%2FRxuxLguNqhrg%3D%3D.f%2BWWJlm9AsMAbAJjJZT%2BOQBqYNXwZgTYGW7Jx9l%2BpxQ%3D",target:"_blank",rel:"noopener noreferrer"},_=o(`<p>协程与线程向来焦孟不离，但事实上是，线程更被我们所熟知，在Python编程领域，单核同时间内只能有一个线程运行，这并不是什么缺陷，这实际上是符合客观逻辑的，单核处理器本来就没法同时处理两件事情，要同时进行多件事情本来就需要正在运行的让出处理器，然后才能去处理另一件事情，左手画方右手画圆在现实中本来就不成立，只不过这个让出的过程是线程调度器主动抢占的。</p><h2 id="线程安全" tabindex="-1"><a class="header-anchor" href="#线程安全"><span>线程安全</span></a></h2><p>系统的线程调度器是假设不同的线程是毫无关系的，所以它平均地分配时间片让处理器一视同仁，雨露均沾。但是Python受限于GIL全局解释器锁，任何Python线程执行前，必须先获得GIL锁，然后，每执行100条字节码，解释器就自动释放GIL锁，让别的线程有机会执行。这个GIL全局解释器锁实际上把所有线程的执行代码都给上了锁，所以，多线程在Python中只能交替执行，即使多个线程跑在8核处理上，也只能用到1个核。</p><p>但其实，这并不是事情的全貌，就算只能用单核处理任务，多个线程之前也并不是完全独立的，它们会操作同一个资源。于是，大家又发明了同步锁，使得一段时间内只有一个线程可以操作这个资源，其他线程只能等待：</p><div class="language-mipsasm line-numbers-mode" data-ext="mipsasm" data-title="mipsasm"><pre class="language-mipsasm"><code>import threading
...
0
0
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>是的，无论是结果，还是过程中，都保持了其一致性，但是我们也付出了相应的代价，那就是任务又回到了线性同步执行，再也没有异步的加持了。话说回来，世界上的事情本来就是这样，本来就没有两全其美的解决方案，又要共享状态，又想多协程，还想变量安全，这可能吗？</p><h2 id="协程是否需要加锁" tabindex="-1"><a class="header-anchor" href="#协程是否需要加锁"><span>协程是否需要加锁</span></a></h2><p>结论当然就是看使用场景，如果协程在操作共享变量的过程中，没有主动放弃执行权(await)，也就是没有切换挂起状态，那就不需要加锁，执行过程本身就是安全的；可是如果在执行事务逻辑块中主动放弃执行权了，会分两种情况，如果在逻辑执行过程中我们需要判断变量状态，或者执行过程中要根据变量状态进行一些下游操作，则必须加锁，如果我们不关注执行过程中的状态，只关注最终结果一致性，则不需要加锁。是的，抛开剂量谈毒性，是不客观的，给一个健康的人注射吗啡是犯罪，但是给一个垂死的人注射吗啡，那就是最大的道德，所以说，道德不是空泛的，脱离对象孤立存在的，同理，抛开场景谈逻辑，也是不客观的，协程也不是虚空的，脱离具体场景孤立存在的，我们应该养成具体问题具体分析的辩证唯物思想，只有掌握了辩证的矛盾思维才能更全面更灵活的看待问题，才能透过现象，把握本质。</p>`,44),y={href:"https://link.segmentfault.com/?enc=aOuNWC7a1JCzFai3ycjkKg%3D%3D.l5t0sKltIhLGYnZPLxsFYIiEbKuxzYikfYFHmurPNGM%3D",target:"_blank",rel:"noopener noreferrer"};function f(w,x){const s=t("ExternalLinkIcon");return l(),c("div",null,[n("h1",d,[n("a",r,[n("span",null,[n("a",u,[a("并发异步编程之争：协程(asyncio)到底需不需要加锁？(线程/协程安全/挂起/主动切换)Python3"),e(s)])])])]),v,m,n("p",null,[n("a",b,[a("2022-03-18"),e(s)])]),k,h,n("p",null,[a("原文转载自「刘悦的技术博客」"),n("a",g,[a("https://v3u.cn/a_id_208"),e(s)])]),_,n("p",null,[a("原文转载自「刘悦的技术博客」 "),n("a",y,[a("https://v3u.cn/a_id_208"),e(s)])])])}const P=i(p,[["render",f],["__file","协程(asyncio)到底需不需要加锁.html.vue"]]),q=JSON.parse('{"path":"/tech/%E5%8D%8F%E7%A8%8B(asyncio)%E5%88%B0%E5%BA%95%E9%9C%80%E4%B8%8D%E9%9C%80%E8%A6%81%E5%8A%A0%E9%94%81.html","title":"并发异步编程之争：协程(asyncio)到底需不需要加锁？(线程/协程安全/挂起/主动切换)Python3","lang":"zh-CN","frontmatter":{"description":"并发异步编程之争：协程(asyncio)到底需不需要加锁？(线程/协程安全/挂起/主动切换)Python3 头像头像 刘悦的技术博客 2022-03-18 阅读 6 分钟 头图头图 原文转载自「刘悦的技术博客」https://v3u.cn/a_id_208 协程与线程向来焦孟不离，但事实上是，线程更被我们所熟知，在Python编程领域，单核同时间内只能...","head":[["meta",{"property":"og:url","content":"https://github.com/King-sj/tech/%E5%8D%8F%E7%A8%8B(asyncio)%E5%88%B0%E5%BA%95%E9%9C%80%E4%B8%8D%E9%9C%80%E8%A6%81%E5%8A%A0%E9%94%81.html"}],["meta",{"property":"og:site_name","content":"blog"}],["meta",{"property":"og:title","content":"并发异步编程之争：协程(asyncio)到底需不需要加锁？(线程/协程安全/挂起/主动切换)Python3"}],["meta",{"property":"og:description","content":"并发异步编程之争：协程(asyncio)到底需不需要加锁？(线程/协程安全/挂起/主动切换)Python3 头像头像 刘悦的技术博客 2022-03-18 阅读 6 分钟 头图头图 原文转载自「刘悦的技术博客」https://v3u.cn/a_id_208 协程与线程向来焦孟不离，但事实上是，线程更被我们所熟知，在Python编程领域，单核同时间内只能..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:image","content":"https://avatar-static.segmentfault.com/272/694/2726948578-60fd1deec0c0b_huge128"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"og:updated_time","content":"2024-10-18T04:29:13.000Z"}],["meta",{"property":"article:author","content":"KSJ"}],["meta",{"property":"article:modified_time","content":"2024-10-18T04:29:13.000Z"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"并发异步编程之争：协程(asyncio)到底需不需要加锁？(线程/协程安全/挂起/主动切换)Python3\\",\\"image\\":[\\"https://avatar-static.segmentfault.com/272/694/2726948578-60fd1deec0c0b_huge128\\",\\"https://segmentfault.com/img/bVcYz7i?spec=cover\\",\\"https://segmentfault.com/img/remote/1460000041568841\\"],\\"dateModified\\":\\"2024-10-18T04:29:13.000Z\\",\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"KSJ\\",\\"url\\":\\"https://github.com/King-sj\\"}]}"]]},"headers":[{"level":2,"title":"线程安全","slug":"线程安全","link":"#线程安全","children":[]},{"level":2,"title":"协程","slug":"协程","link":"#协程","children":[]},{"level":2,"title":"协程安全","slug":"协程安全","link":"#协程安全","children":[]},{"level":2,"title":"协程是否需要加锁","slug":"协程是否需要加锁","link":"#协程是否需要加锁","children":[]}],"git":{"createdTime":1729225753000,"updatedTime":1729225753000,"contributors":[{"name":"King","email":"2175616761@qq.com","commits":1}]},"readingTime":{"minutes":10.14,"words":3041},"filePathRelative":"tech/协程(asyncio)到底需不需要加锁.md","localizedDate":"2024年10月18日","excerpt":"\\n<figure><img src=\\"https://avatar-static.segmentfault.com/272/694/2726948578-60fd1deec0c0b_huge128\\" alt=\\"头像\\" tabindex=\\"0\\" loading=\\"lazy\\"><figcaption>头像</figcaption></figure>\\n<p><strong>刘悦的技术博客</strong></p>\\n<p><a href=\\"https://segmentfault.com/a/1190000041568839/revision\\" target=\\"_blank\\" rel=\\"noopener noreferrer\\">2022-03-18</a></p>","autoDesc":true}');export{P as comp,q as data};
